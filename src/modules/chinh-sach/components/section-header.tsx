...
const SectionHeader = () => {
  return (
    <section className="w-[100%] h-[180px] lg:h-[320px] mx-auto lg:py-20 relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center h-full mx-auto text-black max-w-7xl">
        <div className="px-5 lg:px-0">
          <div className="text-3xl font-bold mb-3">Thông tin chung</div>
          <div className="text-sm">
            <Link href={ROUTES.HOME}>Trang chủ </Link> &ensp;/&ensp;{" "}
            <Link href={ROUTES.PRODUCT}>Các chính sách</Link>
          </div>
        </div>
      </div>
    </section>
