              ...
              <div className="flex justify-center items-center">
                {!currentImage && !uploadedFile && !frameImage ? (
                  ...
                  <>
                    ...
                    <div
                      className={`relative w-full h-full flex items-center justify-center overflow-hidden rounded-md mt-3`}
              ...
              {currentImage && (
                <Dialog>
                  <DialogTrigger asChild>
                    ...
                    >
                      <div className="text-white flex flex-row justify-center items-center gap-4 w-full py-2 px-7 lg:py-4 bg-[rgb(var(--fifteenth-rgb))] hover:opacity-80 text-center rounded-md font-medium transition cursor-pointer">
