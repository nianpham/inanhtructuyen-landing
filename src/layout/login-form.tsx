  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <div className="hidden lg:flex cursor-pointer items-center space-x-1 text-gray-700 hover:text-[rgb(var(--fifteenth-rgb))] transition-colors">
              ...
              <div className="mt-4">
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    >
                      Email{" "}
                      <span className="text-[rgb(var(--fifteenth-rgb))] ml-1">
                        *
                      </span>
                    </label>
                    <input
